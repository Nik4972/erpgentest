...
/**
 * GeoMacroregionComSearch represents the model behind the search form about `backend\models\GeoMacroregionCom`.
 */
class GeoMacroregionComSearch extends GeoMacroregionCom
{
