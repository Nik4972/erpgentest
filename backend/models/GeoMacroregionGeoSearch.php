...
/**
 * GeoMacroregionGeoSearch represents the model behind the search form about `backend\models\GeoMacroregionGeo`.
 */
class GeoMacroregionGeoSearch extends GeoMacroregionGeo
{
